...
func (s *Server) setupRoutes() {
	...
	v1.Use(AuthMiddleware(s.accessManager))
	{
		...
		v1.POST("/images/generations/async", openaiHandlers.ImagesGenerationsAsync)
		v1.POST("/images/edits", openaiHandlers.ImagesEdits)
		v1.POST("/images/edits/async", openaiHandlers.ImagesEditsAsync)
		v1.GET("/images/tasks/:task_id", openaiHandlers.GetImageTask)
